...
bulletSound = pygame.mixer.Sound('art/bullet.mp3')
hitSound = pygame.mixer.Sound('art/hit.mp3')

music = pygame.mixer.music.load('art/music.mp3')
...
class player(object):
    ...
    def hit(self):
        ...
        win.blit(text, text.get_rect(center = (500 / 2, 500 / 2)))
        # win.blit(text, (500 - (text.get_width() / 2), 500 - (text.get_height() / 2)))
